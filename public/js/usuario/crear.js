...
function guardarUsuario(){
    ...
    var url = $("#general_url").val()+"/usuario/guardar";
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('#modal-alert-success').find('.modal-body').eq(0).html('<p>Usuario creado con éxito</p>');
        ...
        error: function (jqXHR, error, state) {
            abrirMensajesValidacion('form-usuario','danger', JSON.parse(jqXHR.responseText));
