...
<?php $__env->startPush('css'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/historial_eventos/index.css')); ?>">
<?php $__env->stopPush(); ?>
            ...
            <div class="col-12 no-padding">
                <div class="row">
                    <div class="col-12 col-md-3 padding-top-none">
                        <div class="md-form">
                        <?php echo Form::label('Modulos',''); ?>

                        <?php echo Form::select(null,[''=>'Seleccione','Usuarios'=>'Usuarios','Expedientes'=>'Expediente','Roles'=>'Roles'],null,['id'=>'modulo','class'=>'form-control']); ?>

                        </div>
                    </div>
                    <div class="col-12 col-md-3 padding-top-none">
                        <div class="md-form">
                        <?php echo Form::label('Eventos',''); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script src="<?php echo e(asset('js/historial_eventos/index.js')); ?>"></script>
    <script>
