...
<div class="col-12 col-md-6 col-lg-4">
    <div class="md-form">
        <?php echo Form::label('no_resolucion','Nª resolución (*)', ['class'=>'active']); ?>

        <?php echo Form::text('no_resolucion',null,['id'=>'no_resolucion','class'=>'form-control required_field numeric no-paste valid-restrict-field valid_lenght', 'data-required'=>'Debe escribir un número de resolución', 'data-min-length'=>'2', 'maxLength'=>'4', 'data-field']); ?>
...
<div class="col-12 col-md-6 col-lg-4">
    <div class="md-form">
        <?php echo Form::label('no_dias_vacacionar','Nª días a vacacionar (*)', ['class'=>'active']); ?>

        <?php echo Form::text('no_dias_vacacionar',null,['id'=>'no_dias_vacacionar','class'=>'form-control required_field numeric no-paste valid-restrict-field valid_lenght', 'data-required'=>'Debe escribir el número de días a vacacionar', 'maxLength'=>'3', 'data-field']); ?>
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            <div class="md-form" id="contenedor_fecha_inicio">
                <?php echo Form::label('fecha_inicio','Inicio (*)', ['class'=>'active']); ?>

                <?php echo Form::date('fecha_inicio',null,['id'=>'fecha_inicio','class'=>'form-control required_field no-paste valid-restrict-field', 'data-required'=>'Debe seleccionar una fecha', 'max'=>date('Y-m-d')]); ?>
        ...
        <div class="col-12 col-md-6">
            <div class="md-form" id="contenedor_fecha_fin">
                <?php echo Form::label('fecha_fin','Fin (*)', ['class'=>'active']); ?>
