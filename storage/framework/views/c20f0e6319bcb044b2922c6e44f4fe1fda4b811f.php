<div class="contenedor col-md-10 mx-auto ">
    <div class="inicio col-md-12 text-center">
        <div class="slider col-md-8">
            <img src="<?php echo e(asset('imagenes/bienvenido/slider.jpg')); ?>" alt="Slider del prototipo" style="width: 100%;height: auto;"/>
        </div>
        <div class="iniciosesion col-md-4">
            <div class="row" style="">
                <div >
                    ...
                    <form class=" frmLogin form-horizontal" role="form" method="POST" action="<?php echo e(route('login')); ?>">
