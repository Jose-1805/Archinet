<?php
    if(!isset($ciudad))$ciudad = new \Archinet\Models\Ciudad();
    if(!isset($departamento))$departamento = new \Archinet\Models\Departamento();
...
<div class="row">
    <div class="col-md-6 col-lg-3">
        <div class="md-form c-select">
            ...
            {!! Form::select('pais',[''=>'Seleccione un país']+\Archinet\Models\Pais::pluck('nombre','id')->toArray(),$departamento->pais_id,['id'=>'select-pais','class'=>'form-control']) !!}
        </div>
    </div>
    <div class="col-md-6 col-lg-3">
    ...
    <div class="col-md-6 col-lg-3">
        <div class="md-form">
            ...
            {!! Form::text('especificaciones',null,['id'=>'especificaciones','class'=>'form-control','maxlength'=>255]) !!}
            <p class="count-length">255</p>
        </div>
    </div>
</div>
