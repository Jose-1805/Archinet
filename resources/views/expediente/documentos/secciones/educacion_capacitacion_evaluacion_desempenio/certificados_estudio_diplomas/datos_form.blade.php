...
<div class="col-12 col-md-6 col-lg-4  campo_certificado_estudio d-none estudio_formal">
    <div class="">
        {!! Form::label('nivel_estudio','Nivel de estudio (*)', ['class'=>'active']) !!}
        {!! Form::select('nivel_estudio',$niveles_estudio_formal,null,['id'=>'nivel_estudio','class'=>'form-control']) !!}
    </div>
</div>

<div class="col-12 col-md-6 col-lg-4  campo_certificado_estudio d-none estudio_no_formal">
    <div class="">
        {!! Form::label('nivel_estudio_no_formal','Nivel de estudio (*)', ['class'=>'active']) !!}
        {!! Form::select('nivel_estudio_no_formal',$niveles_estudio_no_formal,$metadatos->nivel_estudio,['id'=>'nivel_estudio_no_formal','class'=>'form-control']) !!}
    </div>
</div>

<div class="col-12 col-md-6 col-lg-4  campo_certificado_estudio d-none">
    <div class="">
        {!! Form::label('tipo_duracion','Tipo duración (*)', ['class'=>'active']) !!}
        {!! Form::select('tipo_duracion',$tipos_duracion,null,['id'=>'tipo_duracion','class'=>'form-control']) !!}
    </div>
</div>

<div class="col-12 col-md-6 col-lg-4 campo_certificado_estudio d-none">
    <div class="md-form">
        {!! Form::label('duracion','Duración (*)', ['class'=>'active']) !!}
        {!! Form::text('duracion',null,['id'=>'duracion','class'=>'form-control required_field numeric no-paste valid-restrict-field valid_lenght','data-required'=>'Debe escribir una duración','maxlength'=>'3']) !!}
    </div>
</div>

<div class="col-12 col-md-6 col-lg-4 campo_certificado_estudio d-none">
    <div class="md-form">
        {!! Form::label('institucion','Institución', ['class'=>'active']) !!}
        {!! Form::text('institucion',null,['id'=>'institucion','class'=>'form-control required_field alphabetical_space no-paste valid-restrict-field','data-required'=>'Debe escribir una institución','data-field']) !!}
    </div>
</div>

<div class="col-12 col-md-6 col-lg-4 campo_certificado_estudio d-none estudio_formal">
    <div class="md-form">
        {!! Form::label('titulo_obtenido','Titulo obtenido (*)', ['class'=>'active']) !!}
        {!! Form::text('titulo_obtenido',null,['id'=>'titulo_obtenido','class'=>'form-control required_field alphabetical_space no-paste valid-restrict-field valid_lenght', 'data-required'=>'Debe escribir un título obtenido', 'data-min-length'=>'3', 'maxLength'=>'250', 'data-field']) !!}
    </div>
</div>

<div class="col-12 col-md-6 col-lg-4 campo_certificado_estudio d-none estudio_no_formal">
    <div class="md-form">
        {!! Form::label('nombre_curso','Nombre del curso (*)', ['class'=>'active']) !!}
        {!! Form::text('nombre_curso',null,['id'=>'nombre_curso','class'=>'form-control required_field alphabetical_space no-paste valid-restrict-field valid_lenght', 'data-required'=>'Debe escribir un nombre de curso', 'data-min-length'=>'3', 'maxLength'=>'250', 'data-field']) !!}
    </div>
</div>

<div class="col-12 col-md-6 col-lg-4 campo_certificado_estudio d-none">
    <div class="md-form">
        {!! Form::label('graduado','Graduado (*)', ['class'=>'active']) !!}
        <div class="padding-top-10 padding-bottom-30" id="graduado">
            <label for="graduado_si" style="position: relative;">
                <input type="radio" name="graduado" class="check-graduado" value="si" @if($metadatos->graduado == 'si') checked @endif id="graduado_si"/> Si
            </label>
            <label for="graduado_no" style="position: relative;margin-left: 15px;">
                <input type="radio" name="graduado" class="check-graduado" value="no" @if($metadatos->graduado == 'no') checked @endif id="graduado_no"/> No
            </label>
        </div>
    </div>
</div>
...
<div class="col-12 col-md-6 col-lg-4 campo_certificado_laboral d-none estudio_formal fechas_estudio_formal">
    <div class="md-form" id="contenedor_fecha_inicio">
        ...
        {!! Form::date('fecha_inicio',null,['id'=>'fecha_inicio','class'=>'form-control no-paste valid-restrict-field', 'max'=>date('Y-m-d')]) !!}
    </div>
</div>
