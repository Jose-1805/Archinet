...
@section('content')
    ...
    <div class="container-fluid white padding-50">
        <div class="row">
            <p class="titulo_principal">Expediente <strong class="teal-text">{{$user->fullName()}}
                    / {{$seccion->nombre}}</strong></p>
            <div class="col-12">
                ...
                <div class="list-group">
                    <table id="tabla-tipos-documentales" class="table table-striped table-bordered table-responsive-md">
                        ...
                        <tr>
                            ...
                            <th colspan="3"><h5>Funcionario:</h5> <strong>{{$user->fullName()}}</strong></th>
                            <th colspan="2"><h5>Identificacion:</h5>
                                <strong>{{$user->identificacion}}</strong></th>
                    ...
                    <div class="botones">
                        <a href="{{url('/expediente/')}}/{{$user->id }}?type=2" class="btn-guardar btn btn-default btn-submit"
                           id="">REGRESAR</a>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="md-form">
                            ...
                            {!! Form::select('seleccion_tipo_documental',$tipos_documentales,null,['id'=>'seleccion_tipo_documental','class'=>'md-form form-control']) !!}
                        </div>
                        {!! Form::close() !!}
                    </div>
...
@push('js')
    ...
    <script>
        var tiene_opciones = false;
            ...
            @endif
        @if(\Illuminate\Support\Facades\Auth::user()->tieneFunciones($identificador_modulo,['editar'],false,$privilegio_superadministrador) && session('rol')->funcionario != "si")
            tiene_opciones = true;
        @endif
