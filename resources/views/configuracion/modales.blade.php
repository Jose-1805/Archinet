                    ...
                    <div class="row">
                        <div class="col-12 padding-top-none">
                            <div class="md-form">
                                ...
                                {!! Form::password('password',['id'=>'password','class'=>'form-control valid-restrict-field no-paste required_field valid_lenght', 'data-required'=>'Debe escribir su nueva contraseña', 'data-min-length'=>8, 'maxlength'=>30, 'data-field'=>'contraseña nueva', 'placeholder'=>'Escriba su nueva contraseña']) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="md-form">
                                ...
                                {!! Form::password('password_confirm',['id'=>'password_confirm','class'=>'form-control valid-restrict-field no-paste required_field valid_lenght', 'data-required'=>'Debe volver a escribir su nueva contraseña', 'data-min-length'=>8, 'maxlength'=>30, 'data-field'=>'confirme su contraseña', 'placeholder'=>'Vuelva a escribir su nueva contraseña']) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="md-form">
                                ...
                                {!! Form::password('password_old',['id'=>'password_old','class'=>'form-control valid-restrict-field no-paste required_field valid_lenght', 'data-required'=>'Debe escribir su contraseña antigua', 'data-min-length'=>8, 'maxlength'=>30, 'data-field'=>'contraseña antigua', 'placeholder'=>'Escriba su contraseña antigua']) !!}
                            </div>
                        </div>
                    </div>
                {!! Form::close() !!}
...
<div class="modal fade" id="modal-contrasena-actualizada" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-sm modal-dialog-centered modal-notify modal-success" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="{{url('/')}}" class="btn btn-outline-success waves-effect">Aceptar</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body padding-top-none">
                    {!! Form::open(['id'=>'form-configurar-correos']) !!}
                        <div class="row padding-top-none">
                            <div class="col-12">
                                <div class="md-form">
                                    {!! Form::label('correo_solicitud_certificados','Correo para recibir solicitudes de certificado detallado (*)') !!}
                                    {!! Form::text('correo_solicitud_certificados',$configuracion->correo_solicitud_certificados,['id'=>'correo_solicitud_certificados','class'=>'form-control valid_lenght mail valid-restrict-field no-paste required_field','data-required'=>'Debe escribir un correo','data-field'=>'','data-min-length'=>5,'maxlength'=>150]) !!}
                                </div>
                            </div>
                        </div>
                    {!! Form::close() !!}
